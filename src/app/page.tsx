  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <p
          className={
            "fixed left-0 top-0 flex w-full justify-center border-b " +
        ...
        <div
          className={
            "fixed bottom-0 left-0 flex h-48 w-full items-end " +
            "justify-center bg-gradient-to-t from-white via-white " +
            "dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none"
          }
        >
          <a
      ...
      <div
        className={
          "relative z-[-1] flex place-items-center before:absolute before:h-[300px]" +
          ...
          "after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 " +
